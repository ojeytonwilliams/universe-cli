...
- [ ] CODE: Remove explicit environment parsing from the five affected handlers
...
- [ ] CODE: Remove environment context wiring from CLI command definitions
...
- [ ] CODE: Remove environment fields from request types
...
- [ ] CODE: Remove environment fields from response/receipt types
...
- [ ] CODE: Simplify affected stub adapters
...
- [ ] CODE: Rewrite adapter unit tests for the five affected stubs
...
- [ ] CODE: Update shared CLI coverage for `deploy`, `promote`, and `rollback`
...
- [ ] CODE: Update dedicated CLI coverage for `list` and `teardown`
...
- [ ] CODE: Update observability assertions for the five affected commands
...
- [ ] CODE: Review integration coverage for the five affected commands
...
- [ ] TASK: Run validation after the refactor
  - Acceptance:
    - `pnpm test` passes
    - `pnpm lint` passes
    - `pnpm check` passes
